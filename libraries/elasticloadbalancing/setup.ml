...
(* OASIS_START *)
(* DO NOT EDIT (digest: 2d1c8ce93aa58f79935046d629758c37) *)
(*
...
let setup_t =
  {
       ...
       [
            ...
            CustomPlugin.Test.main
              {
                 CustomPlugin.cmd_main =
                   [(OASISExpr.EBool true, ("$test_elb_lwt", []))];
          ...
          ("test_elb_async",
            CustomPlugin.Test.main
              {
                 CustomPlugin.cmd_main =
                   [(OASISExpr.EBool true, ("$test_elb_async", []))];
                 cmd_clean = [(OASISExpr.EBool true, None)];
                 cmd_distclean = [(OASISExpr.EBool true, None)]
              })
       ];
     ...
     package =
       {
          ...
          sections =
            [
               Library
                 ({
                     cs_name = "aws_elasticloadbalancing";
                  ...
                  },
                   {
                      ...
                      bs_build_depends =
                        [
                           FindlibPackage
                             ("aws",
                               Some (OASISVersion.VGreaterEqual "0.1.0"))
                        ];
                   ...
                   },
                   {
                      ...
                      lib_findlib_name = Some "aws-elasticloadbalancing";
                      lib_findlib_containers = []
                   });
               Doc
                 ({
                     cs_name = "aws-elasticloadbalancing";
                     cs_data = PropList.Data.create ();
                     cs_plugin_data = []
                  },
                   {
                      ...
                      doc_title = "aws-elasticloadbalancing Docs";
                      doc_authors = [];
                      doc_abstract = None;
                      doc_format = OtherDoc;
                      doc_data_files = [];
               ...
               Flag
                 ({
                   ...
                   {
                      flag_description = Some "Run the Lwt tests";
               ...
               Flag
                 ({
                   ...
                   {
                      flag_description = Some "Run the Async tests";
                      flag_default = [(OASISExpr.EBool true, false)]
                   });
               Executable
                 ({
                     cs_name = "test_elb_lwt";
                     cs_data = PropList.Data.create ();
                     cs_plugin_data = []
                  },
                   {
                      ...
                      bs_build_depends =
                        [
                           FindlibPackage ("aws", None);
                           FindlibPackage ("aws_elasticloadbalancing", None);
                           FindlibPackage ("aws.lwt", None);
               ...
               Executable
                 ({
                   ...
                   {exec_custom = false; exec_main_is = "test_async.ml"});
               Test
                 ({
                     cs_name = "test_elb_async";
                     cs_data = PropList.Data.create ();
     ...
     oasis_version = "0.4.5";
     oasis_digest = Some "V\228\002\235i\161(Iy\217\225\023\164x\1513";
     oasis_exec = None;
     oasis_setup_args = [];
     setup_update = false
  };;
