...
(* OASIS_START *)
(* DO NOT EDIT (digest: fbdda4146fafe2bd70a2468f4ccf437e) *)
(*
...
let setup_t =
  {
               ...
               Library
                 ({
                   ...
                   },
                   {
                      ...
                      lib_findlib_name = Some "aws-autoscaling";
                      lib_findlib_containers = []
                   });
               Doc
                 ({
                     cs_name = "aws-autoscaling";
                     cs_data = PropList.Data.create ();
                     cs_plugin_data = []
                  },
                   {
                      ...
                      doc_title = "aws-autoscaling Docs";
                      doc_authors = [];
                      doc_abstract = None;
                      doc_format = OtherDoc;
                      doc_data_files = [];
     ...
     oasis_version = "0.4.5";
     oasis_digest = Some "\218\143r~\025\031\246m\232\242\207VLS\206\137";
     oasis_exec = None;
     oasis_setup_args = [];
     setup_update = false
  };;
