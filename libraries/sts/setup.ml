...
(* OASIS_START *)
(* DO NOT EDIT (digest: 13b07a5878bb5382b7556211aec5cbaa) *)
(*
...
let setup_t =
  {
     ...
     oasis_version = "0.4.5";
     oasis_digest = Some "\197&U]e\227T\145\011\175\157k\b\211\176y";
     oasis_exec = None;
     oasis_setup_args = [];
     setup_update = false
  };;
