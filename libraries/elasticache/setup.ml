...
(* OASIS_START *)
(* DO NOT EDIT (digest: 940a8fe39887bb9f1a8463dee912b106) *)
(*
...
let setup_t =
  {
               ...
               Library
                 ({
                   ...
                   },
                   {
                      ...
                      lib_findlib_name = Some "aws-elasticache";
                      lib_findlib_containers = []
                   });
               Doc
                 ({
                     cs_name = "aws-elasticache";
                     cs_data = PropList.Data.create ();
                     cs_plugin_data = []
                  },
                   {
                      ...
                      doc_title = "aws-elasticache Docs";
                      doc_authors = [];
                      doc_abstract = None;
                      doc_format = OtherDoc;
                      doc_data_files = [];
     ...
     oasis_version = "0.4.5";
     oasis_digest = Some "\004\006\006\220j\168\192]\140\0235\203z-\000\021";
     oasis_exec = None;
     oasis_setup_args = [];
     setup_update = false
  };;
