...
(* OASIS_START *)
(* DO NOT EDIT (digest: e4f691118ac2868fca22d026a1ad6eec) *)
(*
...
let setup_t =
  {
       ...
       [
            ...
            CustomPlugin.Test.main
              {
                 CustomPlugin.cmd_main =
                   [(OASISExpr.EBool true, ("$test_ec2_lwt", []))];
          ...
          ("test_ec2_async",
            CustomPlugin.Test.main
              {
                 CustomPlugin.cmd_main =
                   [(OASISExpr.EBool true, ("$test_ec2_async", []))];
                 cmd_clean = [(OASISExpr.EBool true, None)];
                 cmd_distclean = [(OASISExpr.EBool true, None)]
              })
       ];
     ...
     oasis_version = "0.4.5";
     oasis_digest = Some "J\242\209\141$\245\243\220\213g\200n\240\027k\b";
     oasis_exec = None;
     oasis_setup_args = [];
     setup_update = false
  };;
