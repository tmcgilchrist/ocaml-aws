...
(* OASIS_START *)
(* DO NOT EDIT (digest: 1ed1d086d22463de2cbea4c44ebcd7b0) *)
(*
...
let setup_t =
  {
               ...
               Library
                 ({
                   ...
                   },
                   {
                      ...
                      lib_findlib_name = Some "aws-cloudformation";
                      lib_findlib_containers = []
                   });
               Doc
                 ({
                     cs_name = "aws-cloudformation";
                     cs_data = PropList.Data.create ();
                     cs_plugin_data = []
                  },
                   {
                      ...
                      doc_title = "aws-cloudformation Docs";
                      doc_authors = [];
                      doc_abstract = None;
                      doc_format = OtherDoc;
                      doc_data_files = [];
     ...
     oasis_version = "0.4.5";
     oasis_digest = Some "?\025N\128\230Lp3\015\234]H\169b<\160";
     oasis_exec = None;
     oasis_setup_args = [];
     setup_update = false
  };;
