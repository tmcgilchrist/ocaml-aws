...
(* OASIS_START *)
(* DO NOT EDIT (digest: 4cd316cdf2d9c2b7f00585fa04622a0c) *)
(*
...
let setup_t =
  {
               ...
               Library
                 ({
                   ...
                   },
                   {
                      ...
                      lib_findlib_name = Some "aws-cloudtrail";
                      lib_findlib_containers = []
                   });
               Doc
                 ({
                     cs_name = "aws-cloudtrail";
                     cs_data = PropList.Data.create ();
                     cs_plugin_data = []
                  },
                   {
     ...
     oasis_version = "0.4.5";
     oasis_digest = Some "\155\185\177\210MS)\194\245J\246\160\004\023\197\r";
     oasis_exec = None;
     oasis_setup_args = [];
     setup_update = false
  };;
