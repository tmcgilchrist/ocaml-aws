...
(* OASIS_START *)
(* DO NOT EDIT (digest: 9a4b8da57191f7345b098522a814880f) *)
(*
...
let setup_t =
  {
     ...
     oasis_version = "0.4.5";
     oasis_digest =
       Some "\026\012\247\017\152\174h\004\152f\242\242\230\231J\250";
     oasis_exec = None;
     oasis_setup_args = [];
     setup_update = false
  };;
