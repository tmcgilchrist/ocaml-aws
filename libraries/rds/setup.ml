...
(* OASIS_START *)
(* DO NOT EDIT (digest: 9edc9b9bd1275935d6b72c8ab915d95c) *)
(*
...
let setup_t =
  {
     ...
     package =
       {
          ...
          synopsis = "Amazon Relational Database Service";
          description = None;
          categories = [];
     ...
     oasis_version = "0.4.5";
     oasis_digest = Some "\031\187@\223S\141iR\"Z\187\bL\129}\023";
     oasis_exec = None;
     oasis_setup_args = [];
     setup_update = false
  };;
