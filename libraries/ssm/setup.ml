...
(* OASIS_START *)
(* DO NOT EDIT (digest: f5be5cf23e5c59af615771af004b1263) *)
(*
...
let setup_t =
  {
     ...
     oasis_version = "0.4.5";
     oasis_digest = Some "\255>\136\2331)\t)\223v\151\191-\161\132\241";
     oasis_exec = None;
     oasis_setup_args = [];
     setup_update = false
  };;
